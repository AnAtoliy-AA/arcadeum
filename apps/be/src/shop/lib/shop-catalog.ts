...
export const SHOP_CATALOG: Record<string, ShopItemDef> = {
  ...
  'avatar-cat-siam': {
    ...
    category: 'avatar',
    rarity: 'epic',
    nameKey: 'items.avatar.catsiam.name',
    descKey: 'items.avatar.catsiam.desc',
    assetUrl: '/shop/avatars/cat-siam.png',
    defaultPriceAmount: 18,
    defaultPriceCurrency: 'gems',
  },
  'avatar-cat-persian': {
    id: 'avatar-cat-persian',
    category: 'avatar',
    rarity: 'legendary',
    nameKey: 'items.avatar.catpersian.name',
    descKey: 'items.avatar.catpersian.desc',
    assetUrl: '/shop/avatars/cat-persian.png',
    defaultPriceAmount: 38,
    defaultPriceCurrency: 'gems',
  },
  'avatar-cat-bengal': {
    id: 'avatar-cat-bengal',
    category: 'avatar',
    rarity: 'legendary',
    nameKey: 'items.avatar.catbengal.name',
    descKey: 'items.avatar.catbengal.desc',
    assetUrl: '/shop/avatars/cat-bengal.png',
    defaultPriceAmount: 40,
    defaultPriceCurrency: 'gems',
  },
  'avatar-phoenix-cyber': {
    id: 'avatar-phoenix-cyber',
    category: 'avatar',
    rarity: 'legendary',
    nameKey: 'items.avatar.phoenixcyber.name',
    descKey: 'items.avatar.phoenixcyber.desc',
    assetUrl: '/shop/avatars/phoenix-cyber.png',
    defaultPriceAmount: 45,
    defaultPriceCurrency: 'gems',
  },
  'avatar-dragon-cyber': {
    id: 'avatar-dragon-cyber',
    category: 'avatar',
    rarity: 'legendary',
    nameKey: 'items.avatar.dragoncyber.name',
    descKey: 'items.avatar.dragoncyber.desc',
    assetUrl: '/shop/avatars/dragon-cyber.png',
