...
export const settingsMessages = {
  en: {
    ...
    accountDescription: 'Manage your sign-in status and session tokens for this device.',
    accountSignedOut: 'You are browsing without signing in.',
    signedInAs: 'Signed in as {{user}}',
    downloadsTitle: 'Downloads',
    downloadsDescription: 'Access the latest Expo builds for installing on physical devices.'
  },
  es: {
    ...
    accountTitle: 'Cuenta',
    accountDescription: 'Administra tu estado de inicio de sesión y los tokens guardados en este dispositivo.',
    accountSignedOut: 'Estás navegando sin iniciar sesión.',
    signedInAs: 'Sesión iniciada como {{user}}',
    downloadsTitle: 'Descargas',
    downloadsDescription: 'Accede a las últimas compilaciones de Expo para instalarlas en tus dispositivos.'
  },
  fr: {
    ...
    accountTitle: 'Compte',
    accountDescription: 'Gérez votre état de connexion et les jetons enregistrés sur cet appareil.',
    accountSignedOut: 'Vous naviguez sans être connecté.',
    signedInAs: 'Connecté en tant que {{user}}',
    downloadsTitle: 'Téléchargements',
    downloadsDescription: 'Accédez aux dernières compilations Expo à installer sur vos appareils.'
  }
