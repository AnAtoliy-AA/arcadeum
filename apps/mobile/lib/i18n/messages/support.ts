...
export const supportMessages = {
  en: {
    ...
    description: 'Arcade labs, infrastructure, and community events are self-funded today. Your backing keeps the realtime servers online, unlocks more playtest nights, and helps us ship the next wave of prototypes.',
    team: {
    ...
    contribute: {
      ...
      sponsorDescription: 'Set up a monthly or annual contribution to underwrite hosting, QA sessions, and new game prototypes.',
      sponsorCta: 'Sponsor development',
      coffeeTitle: 'One-time boost',
      coffeeDescription: 'Prefer a quick thank-you? Send the crew coffee and snacks so late-night playtests stay energized.',
      coffeeCta: 'Buy the team a coffee',
      paymentTitle: 'Card payment',
      paymentDescription: "Enter an amount and we'll open UniPAY's secure checkout in your browser.",
      paymentCta: 'Enter amount',
      ibanTitle: 'Bank transfer',
      ibanDescription: 'Need to pay by card through your bank? Enter the IBAN {{iban}} to send funds directly to {{appName}}.',
  ...
  es: {
    ...
    description: 'Hoy financiamos por nuestra cuenta los laboratorios de pruebas, la infraestructura y los eventos con la comunidad. Tu aporte mantiene los servidores en tiempo real, habilita más noches de playtest y nos permite lanzar la próxima oleada de prototipos.',
    team: {
    ...
    contribute: {
      ...
      sponsorDescription: 'Configura un aporte mensual o anual que cubra hosting, sesiones de QA y nuevos prototipos de juegos.',
      sponsorCta: 'Patrocinar desarrollo',
      coffeeTitle: 'Impulso puntual',
      coffeeDescription: '¿Prefieres un agradecimiento rápido? Manda café y snacks al equipo para mantener la energía en los playtests nocturnos.',
      coffeeCta: 'Invitar un café',
      paymentTitle: 'Pago con tarjeta',
      paymentDescription: 'Ingresa un monto y abriremos el checkout seguro de UniPAY en tu navegador.',
      paymentCta: 'Ingresar monto',
      ibanTitle: 'Transferencia bancaria',
      ibanDescription: '¿Necesitas pagar con tarjeta desde tu banco? Introduce el IBAN {{iban}} y envía fondos directo a {{appName}}.',
      ibanCta: 'Copiar IBAN',
  ...
  fr: {
    ...
    tagline: 'Aide {{appName}} à progresser rapidement tout en restant accessible à la communauté des jeux de société.',
    description: "Nos laboratoires de tests, l'infrastructure et les événements communautaires sont entièrement autofinancés. Ton soutien maintient les serveurs temps réel, finance de nouvelles soirées playtest et nous permet de livrer la prochaine vague de prototypes.",
    team: {
    ...
    contribute: {
      ...
      sponsorDescription: "Mets en place une contribution mensuelle ou annuelle pour financer l'hébergement, les sessions QA et de nouveaux prototypes.",
      sponsorCta: 'Parrainer le développement',
      coffeeTitle: 'Coup de pouce ponctuel',
      coffeeDescription: "Envie d'un merci rapide ? Offre café et encas pour garder l'équipe en forme pendant les playtests nocturnes.",
      coffeeCta: 'Offrir un café',
      paymentTitle: 'Paiement par carte',
      paymentDescription: 'Indique un montant et nous ouvrons le checkout sécurisé de UniPAY dans ton navigateur.',
      paymentCta: 'Saisir le montant',
      ibanTitle: 'Virement bancaire',
      ibanDescription: "Besoin de payer par carte via ta banque ? Saisis l'IBAN {{iban}} pour envoyer des fonds directement à {{appName}}.",
      ibanCta: "Copier l'IBAN",
      ibanCopied: 'IBAN copié dans le presse-papiers'
    },
    thanks: "Chaque contribution fait évoluer {{appName}}. Merci de nous aider à imaginer l'avenir du jeu de plateau à distance !",
    errors: {
