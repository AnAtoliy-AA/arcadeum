...
export function useLocalAuth() {
  ...
  const checkSession = useCallback(async () => {
    ...
    try {
      ...
      const baseSnapshot = sessionHydrated
        ? sessionTokens
        : await reloadSessionTokens();
      ...
      try {
        ...
        const latestSnapshot = sessionTokens.accessToken
          ? sessionTokens
          : await reloadSessionTokens();
        const snapshotForProfile = latestSnapshot.accessToken
          ? latestSnapshot
          : baseSnapshot;
