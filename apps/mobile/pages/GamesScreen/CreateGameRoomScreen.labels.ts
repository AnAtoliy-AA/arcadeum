...
export function useCreateGameRoomLabels(
  ...
  return {
    ...
    sectionDetails,
    sectionPreview,
    sectionHouseRules: t('games.table.houseRules.title'),
    actionCardCombosLabel: t('games.table.houseRules.actionCardCombos'),
    actionCardCombosHint: t('games.table.houseRules.actionCardCombosHint'),
    idleTimerLabel: t('games.table.houseRules.idleTimer'),
    idleTimerHint: t('games.table.houseRules.idleTimerHint'),
    comingSoonLabel,
    disabledAlertTitle,
