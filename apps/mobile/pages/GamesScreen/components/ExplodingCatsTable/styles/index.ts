/**
 * ExplodingCatsTable styles - modular barrel export.
 *
...
export type ExplodingCatsTableStyles = CardStyles &
  HeaderStyles &
  TableStyles &
  EffectStyles &
  SeatStyles &
...
/**
 * Create all ExplodingCatsTable styles from palette.
 */
export function createStyles(palette: Palette): ExplodingCatsTableStyles {
