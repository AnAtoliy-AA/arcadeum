...
import { HERO_GRADIENT_COORDS } from './CriticalRoom.constants';
...
interface CriticalLobbyContentProps {
...
export function CriticalLobbyContent({
  room,
  displayName,
  displayGame,
  heroGradientColors,
