...
import { createStyles, type CriticalRoomStyles } from './CriticalRoom.styles';
import { useGameActions } from './CriticalRoom.hooks';
import { NeonBackdrop } from './CriticalRoom.components';
import { CriticalLobbyContent } from './CriticalLobbyContent';
import type {
  CriticalRoomHandle,
  CriticalRoomProps,
  ActionBusyType,
...
export const CriticalRoom = forwardRef<CriticalRoomHandle, CriticalRoomProps>(
  ({ ...props }, ref) => {
    ...
    const displayName =
      room?.name ?? fallbackName ?? t('games.room.defaultName');
...
CriticalRoom.displayName = 'CriticalRoom';
