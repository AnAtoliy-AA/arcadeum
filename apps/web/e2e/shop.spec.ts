...
test.describe('Shop redesign · Showcase Locker', () => {
  ...
  test('renders and allows preview of new premium items (Cyber Wolf, Cyber Panther, Cyber Tiger, Cyber Eagle, Elite Shield, Mythic Star, Vanguard Shield, Nexus Star)', async ({
    ...
    const items = [
      ...
      { id: 'avatar-leopard-cyber', name: 'Cyber Leopard' },
      { id: 'avatar-eagle-cyber', name: 'Cyber Eagle Elite' },
      { id: 'avatar-falcon-cyber', name: 'Cyber Falcon' },
      { id: 'avatar-gorilla-cyber', name: 'Cyber Gorilla' },
      { id: 'avatar-panda-cyber', name: 'Cyber Panda' },
      { id: 'avatar-cheetah-cyber', name: 'Cyber Cheetah' },
      { id: 'avatar-wolf-cyber', name: 'Cyber Wolf Elite' },
      { id: 'avatar-tiger-cyber', name: 'Cyber Tiger Elite' },
