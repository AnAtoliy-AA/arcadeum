        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
          {s?.dataCollection?.items?.account && (
            <div className="p-4 rounded-xl bg-white/5 border border-white/10 flex flex-col gap-1">
              ...
              <Typography variant="body" uiSize="sm" className="text-slate-300">
                {s.dataCollection.items.account}
              </Typography>
            </div>
          )}
          ...
          {s?.dataCollection?.items?.communications && (
            <div className="p-4 rounded-xl bg-white/5 border border-white/10 md:col-span-2 flex flex-col gap-1">
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-3 pl-4 list-disc text-slate-300 text-sm">
      ...
      <GlassCard
        ...
        className="p-7 bg-slate-900/60 border-sky-500/30 rounded-2xl flex flex-col gap-4"
      >
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-sky-500/10 border border-sky-500/30 flex items-center justify-center text-sky-400 shrink-0">
            <ShieldIcon size={20} />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-1">
          ...
          {s?.userRights?.items?.objection && (
            <div className="p-3.5 rounded-xl bg-white/5 border border-white/10 sm:col-span-2 text-xs text-slate-300">
              <strong className="text-white block mb-1">
        ...
        <div className="mt-2 pt-4 border-t border-white/10 text-sm text-slate-300">
