...
export const featuredGames: FeaturedGame[] = [
  ...
  {
    id: 'minesweeper_v1',
    nameKey: 'games.minesweeper_v1.name' as TranslationKey,
    descriptionKey: 'games.minesweeper_v1.description' as TranslationKey,
    accentColor: '#ef4444',
    genre: 'Puzzle',
    pace: 'Casual',
    category: 'Puzzle',
    ...
    playingNow: null,
    isPlayable: true,
    landingHref: '/games/minesweeper',
    type: 'puzzle',
    rulesPrefix: 'games.minesweeper_v1.rules',
    rulesKeys: ['objective', 'gameplay', 'scoring'],
    variants: [],
  },
  {
    id: 'sudoku_v1',
    nameKey: 'games.sudoku_v1.name' as TranslationKey,
    descriptionKey: 'games.sudoku_v1.description' as TranslationKey,
    accentColor: '#0ea5e9',
    genre: 'Puzzle',
    pace: 'Casual',
    category: 'Puzzle',
    ...
    playingNow: null,
    isPlayable: true,
    landingHref: '/games/sudoku',
    type: 'puzzle',
    rulesPrefix: 'games.sudoku_v1.rules',
    rulesKeys: ['objective', 'gameplay', 'scoring'],
    variants: [],
  },
  {
    id: 'game_2048_v1',
    nameKey: 'games.game_2048_v1.name' as TranslationKey,
    descriptionKey: 'games.game_2048_v1.description' as TranslationKey,
    accentColor: '#f59e0b',
    genre: 'Puzzle',
    pace: 'Casual',
    category: 'Puzzle',
    ...
    playingNow: null,
    isPlayable: true,
    landingHref: '/games/2048',
    type: 'puzzle',
    rulesPrefix: 'games.game_2048_v1.rules',
    rulesKeys: ['objective', 'gameplay', 'scoring'],
    variants: [],
  },
];
