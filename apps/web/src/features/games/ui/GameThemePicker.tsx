    ...
    <div className={cx('flex flex-col gap-2 w-full min-w-0', className)}>
      ...
      <div
        ...
        className={cx(
          ...
          layout === 'grid'
            ? 'grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 max-[800px]:flex max-[800px]:grid-cols-none max-[800px]:gap-2 max-[800px]:overflow-x-auto max-[800px]:snap-x max-[800px]:scroll-smooth max-[800px]:scrollbar-none max-[800px]:touch-pan-x'
            : 'flex flex-nowrap gap-2 overflow-x-auto pb-1 scroll-smooth scrollbar-none touch-pan-x',
        )}
        role="radiogroup"
            ...
            <button
              ...
              className={cx(
                ...
                layout === 'grid'
                  ...
                  : 'w-24 min-w-[96px] max-w-[96px] shrink-0',
                active
