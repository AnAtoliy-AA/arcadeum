  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center gap-2 py-8">
        ...
        <span className="text-xs text-white/40">Loading rivalry...</span>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col gap-3.5">
      <div className="flex items-center justify-between">
        ...
        <span className="inline-flex items-center gap-1 rounded-full border border-indigo-400/20 bg-indigo-500/10 px-2.5 py-0.5 text-[11px] font-bold text-indigo-300">
          ✨ {t(rivalryKey)}
        </span>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        ...
        <div className="rounded-xl border border-white/10 bg-black/30 p-2.5">
          ...
          <p className="mt-1 font-mono text-lg font-bold text-white">{total}</p>
        </div>
      </div>
