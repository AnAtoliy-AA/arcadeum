...
export const StartButton = (props: ButtonProps) => (
  <Button
    ...
    fontWeight="600"
    borderRadius={12}
    backgroundColor="linear-gradient(135deg, #c7aa2f 0%, #c7aa2f 50%, #8b7500 100%)"
    color="#1a1a2e"
...
export const DeleteButton = (props: ButtonProps) => (
  <Button
    ...
    fontWeight="600"
    borderRadius={12}
    backgroundColor="linear-gradient(135deg, #ef4444 0%, #b91c1c 100%)"
    color="white"
...
interface BotCountButtonProps extends ButtonProps {
  isActive?: boolean;
}

export const BotCountButton = ({ isActive, ...props }: BotCountButtonProps) => (
  <Button
    variant="chip"
    size="sm"
    isActive={isActive}
