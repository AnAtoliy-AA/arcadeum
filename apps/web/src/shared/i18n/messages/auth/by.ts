...
export const by = {
  ...
  forgot: {
    title: 'Скід пароля',
    description:
      'Увядзіце email вашага акаўнта — мы прышлем спасылку для скіду.',
    emailLabel: 'Email',
    submit: 'Адправіць спасылку',
    submitting: 'Адпраўляем...',
    successTitle: 'Праверце пошту',
    successBody:
      'Калі акаўнт з {{email}} існуе, мы адправілі спасылку для скіду пароля. Спасылка дзейнічае 15 хвілін.',
    backToSignIn: 'Назад да ўваходу',
    error: 'Не атрымалася адправіць спасылку. Паспрабуйце яшчэ раз.',
    invalidEmail: 'Увядзіце карэктны email.',
  },
  reset: {
    title: 'Выберыце новы пароль',
    description: 'Не карацей за 8 сімвалаў.',
    passwordLabel: 'Новы пароль',
    confirmLabel: 'Пацвердзіце пароль',
    submit: 'Абнавіць пароль',
    submitting: 'Абнаўляем...',
    successTitle: 'Пароль абноўлены',
    successBody: 'Цяпер вы можаце ўвайсці з новым паролем.',
    signInCta: 'Перайсці да ўваходу',
    missingToken:
      'У спасылцы адсутнічае код скіду. Запытайце новую спасылку са старонкі ўваходу.',
    invalidToken:
      'Спасылка для скіду нядзейсная або скончылася. Запытайце новую.',
    passwordTooShort: 'Пароль павінен быць не менш за 8 сімвалаў.',
    passwordMismatch: 'Паролі не супадаюць.',
    error: 'Не атрымалася абнавіць пароль. Паспрабуйце яшчэ раз.',
  },
};
