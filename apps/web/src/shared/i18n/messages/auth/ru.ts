...
export const ru = {
  ...
  forgot: {
    title: 'Сброс пароля',
    description:
      'Введите email вашего аккаунта — мы пришлём ссылку для сброса.',
    emailLabel: 'Email',
    submit: 'Отправить ссылку',
    submitting: 'Отправляем...',
    successTitle: 'Проверьте почту',
    successBody:
      'Если аккаунт с {{email}} существует, мы отправили ссылку для сброса пароля. Ссылка действует 15 минут.',
  ...
  reset: {
    ...
    signInCta: 'Перейти ко входу',
    missingToken:
      'В ссылке отсутствует код сброса. Запросите новую ссылку со страницы входа.',
    invalidToken:
