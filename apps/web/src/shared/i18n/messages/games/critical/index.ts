...
export async function loadCriticalMessages(locale: string) {
  switch (locale) {
    case 'en':
...
/** Derived type from the English locale structure */
export type CriticalGamesMessages = typeof enMessages;
