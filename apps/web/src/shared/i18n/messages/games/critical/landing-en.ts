export const landing = {
  meta: {
    ...
    keywords:
      'critical card game, exploding card game, exploding kittens online, defuse card game, free card game online, multiplayer card game',
  },
  hero: {
    title: 'Critical',
  ...
  faq: {
    ...
    items: {
      free: {
        question: 'Is Critical free to play?',
        answer:
          'Yes. Critical on Arcadeum is completely free to play in your browser. There is no download required and no payment to start a match.',
      },
      players: {
        question: 'How many players can play Critical?',
        answer:
          'Critical supports two to five players per room. You can fill empty seats with AI bots if you’d like to start a match without waiting for humans.',
      },
      ai: {
        question: 'Can I play Critical against AI?',
        answer:
          'Yes. Every empty seat can be filled with an AI bot, so you can practise solo or round out a smaller group of friends.',
      },
      duration: {
        question: 'How long does a Critical match take?',
        answer:
          'A typical match lasts about 10 to 15 minutes, depending on player count and how many Action cards keep the deck in motion.',
      },
      rules: {
        question: 'What are the basic rules of Critical?',
        answer:
