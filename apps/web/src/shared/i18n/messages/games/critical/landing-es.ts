export const landing = {
  meta: {
    ...
    keywords:
      'critical juego de cartas, juego de cartas explosivo, exploding kittens en línea, juego de cartas gratis, juego de cartas multijugador',
  },
  hero: {
    title: 'Critical',
    tagline:
  ...
  faq: {
    ...
    items: {
      free: {
        question: '¿Critical es gratis?',
        answer:
          'Sí. Critical en Arcadeum es completamente gratis en tu navegador. No requiere descarga ni pago para empezar una partida.',
      },
      players: {
        question: '¿Cuántos jugadores soporta Critical?',
        answer:
          'Critical admite de dos a cinco jugadores por sala. Puedes llenar los huecos vacíos con bots de IA para empezar sin esperar a que se unan humanos.',
      },
      ai: {
        question: '¿Puedo jugar a Critical contra la IA?',
        answer:
          'Sí. Cada hueco vacío puede ocuparse con un bot de IA, así puedes practicar en solitario o completar grupos más pequeños.',
      },
      duration: {
        question: '¿Cuánto dura una partida de Critical?',
        answer:
          'Una partida típica dura de 10 a 15 minutos, según el número de jugadores y cuántas cartas de Acción mantengan el mazo en movimiento.',
      },
      rules: {
        question: '¿Cuáles son las reglas básicas de Critical?',
        answer:
