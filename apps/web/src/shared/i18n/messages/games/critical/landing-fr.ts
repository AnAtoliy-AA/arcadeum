export const landing = {
  meta: {
    ...
    keywords:
      'critical jeu de cartes, jeu de cartes explosif, exploding kittens en ligne, jeu de cartes gratuit, jeu de cartes multijoueur',
  },
  hero: {
    title: 'Critical',
    tagline:
  ...
  faq: {
    ...
    items: {
      free: {
        question: 'Critical est-il gratuit ?',
        answer:
          "Oui. Critical sur Arcadeum est entièrement gratuit dans votre navigateur. Aucun téléchargement n'est requis et aucun paiement n'est nécessaire pour démarrer une partie.",
      },
      players: {
        question: 'Combien de joueurs peuvent jouer à Critical ?',
        answer:
          "Critical accepte de deux à cinq joueurs par salon. Vous pouvez remplir les places vides avec des bots IA pour démarrer sans attendre d'autres humains.",
      },
      ai: {
        question: 'Puis-je jouer à Critical contre une IA ?',
        answer:
          'Oui. Chaque place vide peut être occupée par un bot IA, pour vous entraîner en solo ou compléter un groupe plus petit.',
      },
      duration: {
        question: 'Combien de temps dure une partie de Critical ?',
        answer:
          "Une partie type dure entre 10 et 15 minutes, selon le nombre de joueurs et la quantité de cartes d'Action en circulation.",
      },
      rules: {
        question: 'Quelles sont les règles de base de Critical ?',
        answer:
