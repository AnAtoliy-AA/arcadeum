export const enMessages = {
  pachisi_v1: {
    ...
    game: {
      ...
      noLegalMovesWithRoll: 'Rolled {{value}} - No legal moves available',
      noLegalMovesTurnPassed: 'Rolled {{value}} - No legal moves (turn passed)',
      needSixToExit: 'Need a 6 to enter the track from yard',
      opponentRolledNoMoves: 'Opponent rolled {{value}} - No legal moves',
      passTurn: 'Pass Turn',
