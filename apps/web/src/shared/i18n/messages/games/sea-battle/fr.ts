...
• Destroyer (2 cases) - Petit mais agile`,
    ...
    table: {
      ...
      fieldStatus: {
        yourField: 'Votre Champ',
        opponentField: 'Champ Adverse',
        explored: 'Exploré',
        ...
        damaged: 'endommagé',
        opened: 'ouvert',
        shipsAlive: 'Navires Vivants',
        shipsSunk: 'Navires Coulés',
        shipCells: 'Cases de Navires',
      },
    },
    teamMode: {
    ...
    landing: {
      ...
      board: {
        ...
        cycleHint: 'Cliquez pour changer de thème',
