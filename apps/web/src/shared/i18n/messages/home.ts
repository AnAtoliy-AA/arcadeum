...
export const es = {
  ...
  stepInviteDescription:
    'Comparte el enlace o código de la sala con amigos. Puedен unirse desde cualquier dispositivo al instante.',
  ...
  footerDescription:
    'Tu destino definitivo para experiencias de juego competitivas y casuales.',
  footerPlatformTitle: 'Plataforma',
  footerAllGames: 'Todos los juegos',
  footerSeaBattle: 'Batalla Naval',
  ...
  footerStableRelease: 'VERSIÓN ESTABLE',
  footerCraftedWithLove: 'Creado con pasión para jugadores de todo el mundo.',
};
...
export const fr = {
  ...
  footerDescription:
    'Votre destination ultime pour des expériences de jeu compétitives et décontractées.',
  footerPlatformTitle: 'Plateforme',
  footerAllGames: 'Tous les jeux',
  footerSeaBattle: 'Bataille Navale',
  ...
  footerStableRelease: 'VERSION STABLE',
  footerCraftedWithLove: 'Créé avec passion pour les joueurs du monde entier.',
};
...
export const ru = {
  ...
  featureCrossplatformDescription:
    'Играйте мгновенно в браузере на ПК и мобильных устройствах. Нативные приложения для iOS and Android скоро появятся.',
  ...
  footerDescription:
    'Ваша идеальная платформа для соревновательных и казуальных настольных игр.',
  footerPlatformTitle: 'Платформа',
  footerAllGames: 'Все игры',
  footerSeaBattle: 'Морской бой',
  ...
  footerStableRelease: 'СТАБИЛЬНЫЙ ВЫПУСК',
  footerCraftedWithLove: 'Создано с любовью для игроков со всего мира.',
};
...
export const by = {
  ...
  featureCrossplatformDescription:
    'Гуляйце імгненна ў браўзеры на ПК і мабільных прыладах. Натыўныя прыкладанні для iOS and Android хутка з’явыцца.',
  ...
  featureSpectatorDescription:
    'Глядзіце, как сябры гуляюць у прамым эфіры на вэбе. Падтрымка ТБ хутка з’явіцца.',
  ...
  footerDescription:
    'Ваша ідэальная платформа для спаборніцкіх і казуальных настольных гульняў.',
  footerPlatformTitle: 'Платформа',
  footerAllGames: 'Усе гульні',
  footerSeaBattle: 'Марскі бой',
  footerTournaments: 'Турніры',
  footerLeaderboards: 'Табліцы лідараў',
  ...
  footerPrivacyPolicy: 'Палітыка прыватнасці',
  footerTermsOfService: 'Умовы карыстання',
  footerCookiePolicy: 'Паліка выкарыстання файлаў cookie',
  footerContactUs: 'Звязацца з намі',
  footerStableRelease: 'СТАБІЛЬНЫ ВЫПУСК',
  footerCraftedWithLove: 'Створана з любоўю для гульцоў з усяго свету.',
};
