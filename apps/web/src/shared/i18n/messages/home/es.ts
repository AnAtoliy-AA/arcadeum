export const es = {
  ...
  downloadsTitle: 'Instalar {{appName}}',
  pwaDescription:
  ...
  gameHowToPlay: 'Cómo jugar',
  gameMetaPlayers: 'jugadores',
  gameMetaMatch: 'partida',
  gameMetaPlayingNow: 'jugando ahora',
  gamesPagerLabel: 'Carrusel de juegos destacados',
