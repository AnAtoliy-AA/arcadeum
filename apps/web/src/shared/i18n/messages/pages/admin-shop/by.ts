export const adminShopBy = {
  ...
  totalLabel: '{total} прадметаў',
  showingCount: 'Паказана {current} з {total} прадметаў',
  allLoaded: 'Усе {total} прадметаў загружаны',
...
export type AdminShopI18nBy = typeof adminShopBy;
