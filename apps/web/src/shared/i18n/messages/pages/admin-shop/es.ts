export const adminShopEs = {
  ...
  totalLabel: '{total} artículos',
  showingCount: 'Mostrando {current} de {total} artículos',
  allLoaded: 'Los {total} artículos han sido cargados',
  loadMore: 'Cargar más',
  pagination: {
    prev: 'Anterior',
    next: 'Siguiente',
...
export type AdminShopI18nEs = typeof adminShopEs;
