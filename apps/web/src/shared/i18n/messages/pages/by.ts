...
export const by = {
  admin: {
    ...
    dashboard: {
      ...
      serverResources: {
        title: 'Рэсурсы сервера',
        subtitle: 'Маніторынг CPU, памяці і сістэмных метрык у рэальным часе',
        cpu: 'Працэсар',
        ram: 'АЗП',
        perCore: 'Па ядрах',
        processMemory: 'Памяць працэсу',
        heapUsed: 'Куча (выкарыстана)',
        heapTotal: 'Куча (ўсяго)',
        rss: 'RSS',
        external: 'Вонкавая',
        systemInfo: 'Сістэмная інфармацыя',
        uptime: 'Аптайм',
        loadAvg: 'Сярэдняя нагрузка (1хв / 5хв / 15хв)',
        nodeVersion: 'Node',
        platform: 'Платформа',
        model: 'Мадэль',
        cores: 'ядраў',
