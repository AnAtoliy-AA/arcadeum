export const dailyRewardsFr = {
  ...
  dayLabel: 'Jour {n}',
  errors: {
    alreadyClaimed: "Tu as déjà réclamé la récompense d'aujourd'hui.",
    unauthorized: 'Connecte-toi pour réclamer ta récompense quotidienne.',
    generic: 'Impossible de réclamer. Réessaie.',
  },
  toasts: {
