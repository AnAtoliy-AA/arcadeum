...
export const developersEs: typeof developersEn = {
  ...
  stats: {
    latency: '< 50ms',
    latencyLabel: 'Latencia WebSocket Global',
    rateLimit: '120 pet/min',
    rateLimitLabel: 'Límite Gratuito de API',
    uptime: '99.99%',
    uptimeLabel: 'Disponibilidad del Gateway',
    sdk: 'v1.4',
    sdkLabel: 'SDKs TypeScript y Python',
  },
  sdkHero: {
