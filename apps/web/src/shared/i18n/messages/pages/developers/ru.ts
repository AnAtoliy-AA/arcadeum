...
export const developersRu: typeof developersEn = {
  ...
  stats: {
    latency: '< 50мс',
    latencyLabel: 'Задержка WebSocket шлюза',
    rateLimit: '120 зап/мин',
    rateLimitLabel: 'Лимит бесплатного тарифа API',
    uptime: '99.99%',
    uptimeLabel: 'Доступность шлюза',
    sdk: 'v1.4',
    sdkLabel: 'SDK для TypeScript и Python',
  },
  sdkHero: {
