...
import { adminXpBackfillEs } from './admin-xp-backfill/es';
  ...
  admin: {
    ...
    dashboard: {
      ...
      serverResources: {
        ...
        subtitle: 'Métricas de CPU, memoria y sistema en tiempo real',
        cpu: 'CPU',
        ram: 'RAM',
        perCore: 'Por núcleo',
        ...
        loadAvg: 'Carga promedio (1m / 5m / 15m)',
        nodeVersion: 'Node',
        platform: 'Plataforma',
        model: 'Modelo',
        cores: 'núcleos',
    ...
    adminXpBackfill: adminXpBackfillEs,
  },
