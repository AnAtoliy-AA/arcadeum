export const shopEs = {
  ...
  items: {
    ...
    name_color: {
      ...
      magma: { name: 'Magma', desc: 'Un degradado de magma rojo y naranja fundidos.' },
      oceanic: { name: 'Oceánico', desc: 'Un degradado azul oceánico profundo.' },
      forest: { name: 'Bosque', desc: 'Un degradado verde exuberante de bosque.' },
      prismatic: { name: 'Prismático', desc: 'Un degradado prismático vibrante y cambiante.' },
    ...
    aura: {
      ...
      neon: { name: 'Aura neón', desc: 'Un halo brillante de verde neón y cian.' },
      solar: { name: 'Aura solar', desc: 'Un halo solar radiante.' },
      magma: { name: 'Aura magma', desc: 'Un brillo de magma fundido caliente.' },
    ...
    frame: {
      ...
      magma: { name: 'Marco magma', desc: 'Un anillo de magma fundido caliente.' },
      oceanic: { name: 'Marco oceánico', desc: 'Un anillo azul oceánico profundo.' },
