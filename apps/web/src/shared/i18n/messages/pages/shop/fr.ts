export const shopFr = {
  ...
  items: {
    ...
    name_color: {
      ...
      magma: { name: 'Magma', desc: 'Un dégradé de magma rouge et orange fondus.' },
      oceanic: { name: 'Océanique', desc: 'Un dégradé bleu océanique profond.' },
      forest: { name: 'Forêt', desc: 'Un dégradé vert forêt luxuriant.' },
      prismatic: { name: 'Prismatique', desc: 'Un dégradé prismatique éclatant et changeant.' },
    ...
    aura: {
      ...
      neon: { name: 'Aura néon', desc: 'Un halo éclatant de vert néon et de cyan.' },
      solar: { name: 'Aura solaire', desc: 'Un halo solaire éclatant.' },
      magma: { name: 'Aura magma', desc: 'Un éclat de magma fondu chaud.' },
    ...
    frame: {
      ...
      magma: { name: 'Cadre magma', desc: 'Un anneau de magma fondu chaud.' },
      oceanic: { name: 'Cadre océanique', desc: 'Un anneau bleu océanique profond.' },
