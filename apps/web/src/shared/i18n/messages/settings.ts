...
export const es = {
  ...
  themeOptions: {
    ...
    neonDark: {
      label: 'Neón oscuro',
      description: 'Estilo vaporwave de alto contraste para mesas dramáticas.',
    },
    violetDark: {
      label: 'Violet Dark',
      description: 'Deep violet-black with lavender glass and purple glow.',
...
export const ru = {
  ...
  musicPause: 'Пауза',
  musicStop: 'Остановить',
  musicNext: 'Следующий трек',
  musicPrev: 'Предыдущий трек',
  ...
  blockedUsersDescription:
    'Заблокированные пользователи не сможете присылать вам приглашения в игру.',
...
export const by = {
  ...
  musicPause: 'Паўза',
  musicStop: 'Спыніць',
  musicNext: 'Наступны трэк',
  musicPrev: 'Папярэдні трэк',
...
export type SettingsMessages = DeepPartial<typeof en>;
