...
import * as tokenPage from './tokenPage';
...
export interface WalletMessages {
  ...
  tokenPage: tokenPage.TokenPageMessages;
  history: {
    filterAll: string;
    filterCoins: string;
    filterGems: string;
