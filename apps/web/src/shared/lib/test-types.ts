...
type TestPaths = Paths<EnglishTranslations>;
...
type TestStringPaths = StringPaths<EnglishTranslations>;
...
type TestPathValue1 = PathValue<EnglishTranslations, 'common.actions.login'>;
// Expected: string

type TestPathValue2 = PathValue<EnglishTranslations, 'chat.send'>;
// Expected: string

type TestPathValue3 = PathValue<EnglishTranslations, 'common.actions'>;
...
type TestOptional = PathValue<EnglishTranslations, 'common.labels.email'>;
...
type TestNestedObject = PathValue<EnglishTranslations, 'common.actions'>;
...
// ============================================================================
// Runtime validation helpers (for development only)
// ============================================================================
/**
