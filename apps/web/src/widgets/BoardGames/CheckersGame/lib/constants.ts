...
export const CHECKERS_VARIANTS: ReadonlyArray<CheckersVariantOption> = [
  {
    ...
    description:
      'games.checkers_v1.variants.classic.description' as TranslationKey,
    emoji: '♟️',
  ...
  },
  {
    ...
    description:
      'games.checkers_v1.variants.neon.description' as TranslationKey,
    emoji: '💡',
  ...
  },
  {
    ...
    description:
      'games.checkers_v1.variants.wood.description' as TranslationKey,
    emoji: '🪵',
  ...
  },
  {
    ...
    description:
      'games.checkers_v1.variants.marble.description' as TranslationKey,
    emoji: '🏛️',
  ...
  },
  {
    ...
    description:
      'games.checkers_v1.variants.neon_glow.description' as TranslationKey,
    emoji: '🌟',
    gradient: 'linear-gradient(135deg, #0f172a 0%, #1e1b4b 100%)',
    lightGradient:
      'linear-gradient(90deg, #0f172a 0%, #4338ca 40%, #7c3aed 80%, #0f172a 100%)',
  },
];
