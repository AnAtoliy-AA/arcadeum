...
import type { HeartsThemeTokens } from './theme';

export function sharedThemeToHearts(theme: GameTheme): HeartsThemeTokens {
  ...
  return {
    variant: theme.id as HeartsThemeTokens['variant'],
    emoji: theme.emoji,
