  ...
  return (
    <PlayerCardStyled $isActive={$isActive}>
      ...
      {capturedPieces.length > 0 && (
        <div className="box-border flex flex-row items-stretch gap-2 -mt-8 opacity-[0.5]">
          {capturedPieces.map((p, i) => (
            <span className="box-border text-[11px]" key={i}>
      ...
      <div className="box-border flex flex-row items-stretch gap-8 -mt-10">
        ...
        >
          ...
          <span className="box-border text-[40px] font-semibold text-[rgba(148,_163,_184,_0.6)] uppercase -mt-2">
            MAIN
          </span>
        </div>
        <div
