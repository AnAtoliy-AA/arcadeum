...
export function SolitaireBoard({
  ...
  return (
    <div
      ...
      className="relative w-full rounded-2xl sm:rounded-3xl border border-[var(--sol-table-border)] bg-black/20 backdrop-blur-[2px] p-1.5 sm:p-4 shadow-2xl select-none transition-colors duration-200 overflow-hidden"
    >
