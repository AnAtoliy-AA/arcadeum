...
export const MainGameArea = ({ className, ...props }: CommonProps) => (
  <div
    className={cx(
      'box-border flex flex-col items-stretch gap-4 w-full flex-1 min-h-0 min-w-0 p-2',
...
export const GameBoardWrapper = ({ className, ...props }: CommonProps) => (
  <div
    className={cx(
      'box-border flex flex-row items-stretch gap-4 flex-wrap w-full justify-center',
...
export const BoardContainer = ({
  ...
  <div
    className={cx(
      'box-border flex flex-col items-stretch flex-1 max-w-[520px] w-full',
