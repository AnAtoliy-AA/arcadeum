...
const API_MESSAGES_EN = {
  ...
  games: {
    ...
    rematchParticipantRequired: "At least one consenting participant is required for a rematch.",
    startRequiresTwoPlayers: "At least two players are required to start.",
    catCombosExplodingOnly: "Cat combos are only supported for Exploding Cats sessions.",
    desiredCardRequired: "Desired card is required for trio combo.",
    drawActionExplodingOnly: "Draw action is only supported for Exploding Cats sessions.",
    explodingCatsDisabled: "Exploding Cats is not enabled for this room.",
    historyNotesExplodingOnly: "History notes are only supported for Exploding Cats sessions.",
    originalHostOnlyRematch: "Only the original host may initiate a rematch.",
    playActionExplodingOnly: "Play action is only supported for Exploding Cats sessions.",
  ...
  chat: {
    ...
    additionalParticipantRequired: "Provide at least one additional participant",
    ws: {
...
type ApiMessagesShape<T> = {
  [K in keyof T]: T[K] extends string ? string : ApiMessagesShape<T[K]>;
};

type ApiMessagesDictionary = ApiMessagesShape<typeof API_MESSAGES_EN>;

const API_MESSAGES_ES = {
  generic: {
    unknownError: "Algo salió mal. Inténtalo de nuevo.",
    validationError: "Algunos campos no son válidos. Revísalos e inténtalo otra vez.",
  },
  payments: {
  ...
  games: {
    ...
    rematchParticipantRequired: "Se requiere al menos un participante que acepte la revancha.",
    startRequiresTwoPlayers: "Se necesitan al menos dos jugadores para iniciar.",
    catCombosExplodingOnly: "Las combinaciones de gatos solo están disponibles para Exploding Cats.",
    desiredCardRequired: "Se requiere la carta deseada para la combinación de trío.",
    drawActionExplodingOnly: "La acción de robar solo está disponible para Exploding Cats.",
    explodingCatsDisabled: "Exploding Cats no está habilitado en esta sala.",
    historyNotesExplodingOnly: "Las notas de historial solo están disponibles para Exploding Cats.",
    originalHostOnlyRematch: "Solo el anfitrión original puede iniciar una revancha.",
    playActionExplodingOnly: "La acción de jugar solo está disponible para Exploding Cats.",
    ...
    ws: {
      ...
      desiredCardRequired: "desiredCard es obligatorio para combinaciones de trío.",
  ...
  auth: {
    ...
    userNotFoundForRefreshToken: "Usuario no encontrado para el token de refresco",
    ...
    tokenExchangeMissingAccessToken: "El intercambio de tokens no entregó access_token",
  },
  chat: {
    userContextMissing: "Falta el contexto del usuario",
    additionalParticipantRequired: "Proporciona al menos un participante adicional",
    ws: {
...
const API_MESSAGES_FR = {
  ...
  games: {
    ...
    inviteCodeRequired: "Un code d'invitation est requis pour rejoindre cette salle.",
    ...
    rematchParticipantRequired: "Au moins un participant consentant est requis pour une revanche.",
    startRequiresTwoPlayers: "Au moins deux joueurs sont nécessaires pour démarrer.",
    catCombosExplodingOnly: "Les combos de chats sont réservés aux sessions Exploding Cats.",
    desiredCardRequired: "La carte souhaitée est requise pour une combinaison trio.",
    drawActionExplodingOnly: "L'action piocher est réservée aux sessions Exploding Cats.",
    explodingCatsDisabled: "Exploding Cats n'est pas activé pour cette salle.",
    historyNotesExplodingOnly: "Les notes d'historique sont réservées aux sessions Exploding Cats.",
    originalHostOnlyRematch: "Seul l'hôte d'origine peut lancer une revanche.",
    playActionExplodingOnly: "L'action jouer est réservée aux sessions Exploding Cats.",
  ...
  auth: {
    ...
    userNotFoundForRefreshToken: "Utilisateur introuvable pour ce jeton de rafraîchissement",
    oauthClientMismatch: "Client OAuth incompatible",
    unableToValidateOauthTokens: "Impossible de valider les jetons OAuth",
    tokenExchangeMissingAccessToken: "L'échange de jetons n'a pas retourné access_token",
  },
  chat: {
    userContextMissing: "Contexte utilisateur manquant",
    additionalParticipantRequired: "Fournissez au moins un participant supplémentaire",
    ws: {
